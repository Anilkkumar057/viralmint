                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-8 rounded-[1.8rem] border border-white/10 bg-white/[0.03] p-5">
                    ...
                    <div className="mt-5 flex flex-wrap gap-3">
                      ...
                      <button
                        onClick={() => router.push("/premium-tools")}
                        className="rounded-[1rem] border border-white/10 bg-white/[0.04] px-5 py-3 text-sm text-white/65 transition-all hover:border-yellow-400/30 hover:text-yellow-200"
                      >
                        Thumbnails
                      </button>
                    </div>
