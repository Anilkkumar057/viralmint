  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      <div className="relative">
        ...
        <section className="relative mx-auto max-w-7xl px-5 pt-24 pb-20">
          ...
          <div className="grid items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-8 max-w-2xl text-lg leading-9 text-white/62">
                Viral Mint is the emotionally intelligent creator operating system
                for hooks, scripts, thumbnails, emotional storytelling, audience
                retention, and creator growth momentum.
              </p>
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                ...
                <Link
                  href="/studio"
                  className="rounded-[1.2rem] bg-gradient-to-r from-yellow-300 to-yellow-500 px-8 py-4 text-sm font-black text-black shadow-[0_22px_70px_rgba(255,208,74,0.24)] transition-all hover:scale-[1.03]"
                >
                  Launch Creator OS →
                </Link>

                <button className="rounded-[1.2rem] border border-yellow-400/20 bg-black/30 px-7 py-4 text-sm text-white/75 transition-all hover:border-yellow-400/40 hover:text-yellow-200">
                  Watch Demo ▷
                </button>
                  ...
                  <div className="mt-6 grid gap-4 md:grid-cols-2">
                    ...
                    <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-5">
                      ...
                      <p className="mt-3 text-sm leading-7 text-white/55">
                        AI adapts to your creator style, audience emotion,
                    ...
                    <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-5">
                      ...
                      <p className="mt-3 text-sm leading-7 text-white/55">
                        Generate high-retention hooks and scripts
                        designed for modern creator platforms.
                      </p>
                    </div>
