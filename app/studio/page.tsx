"use client";
import PremiumToolsCard from "@/components/PremiumToolsCard";
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_14%_8%,rgba(126,242,194,0.30),transparent_26%),radial-gradient(circle_at_88%_12%,rgba(245,199,107,0.26),transparent_24%),radial-gradient(circle_at_50%_96%,rgba(255,107,95,0.12),transparent_30%),linear-gradient(135deg,#fffaf2_0%,#fff7e8_45%,#f7fff9_100%)] pb-32 text-black">
      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-8">
        ...
        {vaultOpen && (
          <section className="animate-fade-rise mt-10 rounded-[2rem] border border-black/10 bg-white/65 p-6 shadow-[0_20px_70px_rgba(126,242,194,0.12)] backdrop-blur-xl">
            ...
            {vaultItems.length === 0 ? (
              ...
              <div className="space-y-4">
                {vaultItems.map((item) => (
                  <div
                    key={item.id}
                    className="animate-fade-rise rounded-[1.5rem] border border-black/10 bg-[#fffaf2]/70 p-5 hover:bg-white"
                  >
                    <button
        ...
        <section className="flex flex-1 flex-col items-center justify-center py-20 text-center">
          ...
          {upgradeNotice && (
            <div className="animate-fade-rise mt-8 w-full max-w-2xl overflow-hidden rounded-[2.3rem] border border-[#f5c76b]/30 bg-[linear-gradient(135deg,rgba(255,250,242,0.96),rgba(255,245,225,0.96))] p-7 text-left shadow-[0_25px_80px_rgba(245,199,107,0.18)] backdrop-blur-xl">
              ...
              <div className="mt-7 rounded-[1.6rem] border border-[#7ef2c2]/20 bg-[#effff7] p-5">
                ...
                <p className="mt-3 text-sm leading-7 text-black/58">
                  Founding creators currently receive access before wider public
                  rollout.
                </p>
              </div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <button
                  onClick={() => router.push("/pricing")}
                  className="rounded-full bg-black px-7 py-4 text-xs uppercase tracking-[0.28em] text-white shadow-[0_12px_38px_rgba(126,242,194,0.18)] hover:scale-[1.03]"
                >
                ...
                <button
                  ...
                  className="rounded-full border border-black/10 bg-white/70 px-7 py-4 text-xs uppercase tracking-[0.25em] text-black/45 hover:bg-black hover:text-white"
                >
                  Stay in Studio
                </button>
              </div>
          ...
          <div className="mt-10 w-full max-w-3xl rounded-[2.5rem] border border-black/10 bg-white/55 p-6 shadow-[0_25px_80px_rgba(126,242,194,0.12)] backdrop-blur-xl">
            ...
            <button
              ...
              disabled={loading}
              className="animate-soft-pulse mt-6 rounded-full bg-black px-10 py-4 text-sm uppercase tracking-[0.25em] text-white shadow-[0_10px_30px_rgba(126,242,194,0.25)] hover:scale-[1.03] hover:shadow-[0_14px_50px_rgba(126,242,194,0.40)] disabled:opacity-40"
            >
              ...
              {expanded.length > 0 && (
                <div className="animate-fade-rise space-y-4">
                  ...
                  {expanded.map((item, index) => (
                    <div
                      key={index}
                      className="animate-fade-rise rounded-[1.5rem] border border-black/10 bg-white/70 p-5 text-sm leading-7 text-black/70 shadow-[0_12px_40px_rgba(126,242,194,0.08)]"
                    >
                      {item}
                    </div>
                  ))}
      ...
      <div className="fixed bottom-4 left-1/2 z-50 w-[calc(100%-2rem)] max-w-xl -translate-x-1/2 rounded-[2rem] border border-black/10 bg-white/80 p-3 shadow-[0_20px_70px_rgba(126,242,194,0.18)] backdrop-blur-xl">
        <div className="flex items-center justify-center gap-3">
          <button
            ...
            className="animate-soft-pulse rounded-full bg-black px-8 py-3 text-xs uppercase tracking-[0.25em] text-white shadow-[0_10px_30px_rgba(126,242,194,0.22)] hover:scale-[1.03] hover:shadow-[0_12px_40px_rgba(126,242,194,0.36)] disabled:opacity-40"
          >
            {loading ? "Generating..." : "Generate"}
          </button>
        </div>
